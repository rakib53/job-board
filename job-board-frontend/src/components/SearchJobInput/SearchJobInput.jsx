...
import {
  ...
  setSearchJobTitle,
} from "../../features/searchInputSlice/searchInputSlice";
...
const SearchJobInput = () => {
  ...
  // Setting the search job title and location when click search button
  const handleSearchJob = () => {
    dispatch(setSearchJobTitle(jobTitle));
    dispatch(setSearchJobLocation(jobLocation));
  };
      ...
      <div className={styles.jobSearchInputWrapper}>
        <div className={styles.jobSearchInput}>
          ...
          <div
            ...
            className={styles.searchjobBtnWrapper}
          >
            <button className="primaryBtn">Search</button>
          </div>
        </div>
        <span className={styles.popularSearch}>
          Popular: UI Design, UX Designer, Software developer
        </span>
      </div>
    </div>
  );
